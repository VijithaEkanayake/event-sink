...
import org.wso2.carbon.event.sink.config.stream.StreamConfiguration;
import org.wso2.carbon.event.sink.config.stream.Property;
import org.wso2.carbon.event.sink.config.stream.StreamEntry;
...
public class BamServerProfileUtils {
    ...
    public void addResource(String urlSet, String ip, String authenticationPort, String receiverPort, String userName, String password, boolean isSecure, boolean isLoadbalanced,
        ...
        EventSinkConfigXml mediatorConfigurationXml = new EventSinkConfigXml();
    ...
    public EventSink getResource(String bamServerProfileLocation){
        try {
